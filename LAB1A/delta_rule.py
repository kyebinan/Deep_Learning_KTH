...
def delta_learning_batch_without_bias(X, y, epochs = 50, learning_rate = 0.001, batch_size=10):
    """
    Train a linear regression model using the Delta learning rule in batch mode without bias.
